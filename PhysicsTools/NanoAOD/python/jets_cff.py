...
fatJetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        particleNetMD_QCDbb = Var("bDiscriminator('pfMassDecorrelatedParticleNetJetTags:probQCDbb')",float,doc="Mass-decorrelated ParticleNet tagger raw QCDbb score",precision=10),
        particleNetMD_QCDb = Var("bDiscriminator('pfMassDecorrelatedParticleNetJetTags:probQCDb')",float,doc="Mass-decorrelated ParticleNet tagger raw QCDb score",precision=10),
        particleNetMD_QCDothers = Var("bDiscriminator('pfMassDecorrelatedParticleNetJetTags:probQCDothers')",float,doc="Mass-decorrelated ParticleNet tagger raw QCDothers score",precision=10),
